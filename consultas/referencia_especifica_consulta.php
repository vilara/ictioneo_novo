...
// funcoes ----------------------------------------------------
      ...
      // -----------------------------------  inicio da edi��o tipo input da tabela -------------------------------------
                                          ...
                                          var idcoord = $(this).parents('tr').attr('res'); // seleciona o id ds especie para identificar a especie a ser modificado
                                          ...
                                          url: "ajax/editar_ref_especifica.php",   // arquivo de edicao
      ...
      // fim da edicao tipo input
        ...
        // -----------------------------------  inicio da edi��o tipo select da tabela -------------------------------------
                                            ...
                                            if($('td > select').length > 0) {return;}   // fun��o para permitir apenas 01 select
                                            ...
                                            if(tab1 == 'dados_ref'){ sele += "<option value='"+arr[i].iddados_ref+"'>"+arr[i].referencia_esp+"</option>";}
                                            ...
                                            if (tab1 == 'origem'){ sele += "<option value='Revista'>Revista</option>";sele += "<option value='Peri&oacute;dico'>Peri&oacute;dico</option>";sele += "<option value='Artigo'>Artigo</option>";sele += "<option value='Relat&oacute;rio T&eacute;cnico'>Relat&oacute;rio T&eacute;cnico</option>";sele += "<option value='Outros'>Outros</option>";} // caso da mudan�a da situa��o do militar
     ...
     // fun��o para mostrar a tabela de consulta com os respectivos filtros ---------------------------------------------------------------



                                            function tabela(value_referencia){

                                            var filtro = " WHERE d.iddados_ref > 0 "+value_referencia;
                                            ...
                                            url: "ajax/ref_especifica_consulta_aj.php",
                                            ...
                                            var out = "<h2>Referência específica</h2><table id='tblEditavel' class='bordasimples' align='center' width='90%' >";

                                            out += "<thead><tr  class='titulo'>"; 
                                            
                                            out += "<th title='' res='' res1='' >Referência</th>";

                                            out += "<th title='dados_ref' res='referencia_esp' res1='iddados_ref' >Referência Específica</th>";
                                            
                                            out += "<th title='coord_esp' res='coord_lat' res1='idcoord_esp' >Latitude</th>";
                                            
                                            out += "<th title='coord_esp' res='coord_long' res1='idcoord_esp' >Longitude</th>";
                                            
                                            out += "<th title='dados_ref' res='ano_ini' res1='iddados_ref' >Ano ini</th>";
                                            
                                            
                                            out += "<th title='dados_ref' res='ano_fim' res1='iddados_ref' >Ano fim</th>";
                                            
                                            out += "<th title='dados_ref' res='nr_col' res1='iddados_ref' >Nr Col</th>";
                                            
                                            out += "<th title='dados_ref' res='obs' res1='iddados_ref' >Obs</th></tr></thead><tbody>";
                                           ...
                                           // out += "<th>Excluir</th>";
                                            ...
                                            out += "<tr title='"+arr[i].iddados_ref+"' res='"+arr[i].idcoord_esp+"'>";
                                            
                                            out += "<td >"+arr[i].referencia+"</td>";

                                            out += "<td class='editavel' >"+arr[i].referencia_esp+"</td>";

                                            out += "<td class='editavel' >"+arr[i].coord_lat+"</td>";
                                            
                                            out += "<td class='editavel' >"+arr[i].coord_long+"</td>";
                                            
                                            out += "<td class='editavel' >"+arr[i].ano_ini+"</td>";  
                                            
                                            out += "<td class='editavel'  >"+arr[i].ano_fim+"</td>";  
                                            
                                            out += "<td class='editavel' >"+arr[i].nr_col+"</td>";  
                                            
                                            out += "<td class='editavel' >"+arr[i].obs+"</td></tr>";                                
                                        


                                         //   out += "<td class='excluir'><a href='#'><center><img src='imagens/icon_del.png' /></center></a></td>";
                                            ...
                                            // fun�ao para listar ref especifica filtrada
    ...
    // lista das refer�ncias para o filtro da consulta de registros----------------------------------------------------------------------
          ...
          data: {
           ...
           var out = "<option value='0'>Escolha a op&ccedil;&atilde;o...</option>";
            out += "<option value='0'>Todass</option>";
    ...
    // filtro para ativa��o da tabela resposta------------------------------------------------------------------------
   ...
   // lista_referencia_esp();
              ...
              //    var value_ref_esp = $('#referencia_esp').val();
                ...
                //  value = " AND id_ref = "+value_referencia;
                  ...
                  value = " AND ref.idref_bibliografica = "+value_referencia;
               ...
               //   if(value_referencia == 0){lista_referencia_esp(); value="";}else{lista_filt_ref_esp(value_referencia_esp);}
                 ...
                 }); // fim do filtro para ativa��o da tabela resposta------------------------------------------------------------------------
...
<form id="form" method="post" enctype="multipart/form-data">
    ...
    <CENTER><h2>Referências Específicas</h2></CENTER>
