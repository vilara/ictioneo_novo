...
<table cellspacing="0" cellpadding="0" border="0" class="display" id="listausers">
	<thead>
		<tr>
			<th>Referência</th>
			<th>Referência específica</th>
			<th>Ordem</th>
			<th>Família</th>
			<th>Gênero/Espécie</th>
			<th>Abundância</th>
		...
		<?php
			...
			while ($res = $user->retornaDados()) :
				echo "<tr>";
					...
					printf('<td align="left">%s</td>', $res->referencia_esp);
					printf('<td align="left">%s</td>', $res->ordem);
					printf('<td align="left">%s</td>', $res->familia);
					printf('<td align="left">%s</td>', $res->nome);	
					printf('<td align="center">%s</td>', $res->abund);				
					printf('<td align="center">
					<a href="?m=autor&t=incluir" title="Novo Cadastro"><img src="images/add.png" alt="Novo cadastro" /></a>
					<a href="?m=autor&t=editar&idregistro=%s" title="Editar Cadastro"><img src="images/edit.png" alt="Editar autor" /></a>
					<a href="?m=autor&t=excluir&idregistro=%s" title="Excluir Cadastro"><img src="images/del.png" alt="Excluir autor" /></a>
					
					</td>',$res->idregistro,$res->idregistro);
				echo "</tr>";
			endwhile /**/
		?>
